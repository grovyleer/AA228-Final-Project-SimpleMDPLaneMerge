...
class Qlearning:
    ...
    def updateQ(self, q_s):
        ...
        if next_state == -1:
            ...
            chosen_action = np.argmax(self.Q[next_state, :])
...
def main():
    ...
    output_file = "Qlearning_Policy.py"
    start_time = time.time()

    # Train
    model = Qlearning(input_file, output_file)
    ...
    filename_plot = "Rewards_QL.png"
    filename_plot_data = "Rewards_QL.csv"
